...
namespace API.Data
{
    public class UserRepository : IUserRepository
    {
        ...
        public async Task<PagedList<MemberDto>> GetMembersAsync(UserParams userParams)
        {
           ...
           //excludes the current logged in user from the user request
        ...
        {
            //return the username where the username in the list is equal to the given username
            return await _context.Users
            .Include(p => p.Photos)
        ...
        {
            //tells the entity tracker that something in the entity(appUser) has changed
